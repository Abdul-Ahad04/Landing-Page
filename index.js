...
document.getElementById("changeGreen").onclick = function(){
	...
	document.querySelector('.starbucks').src ="/images/frappuccino-drink-chocolate-starbucks.png";
...
document.getElementById("changePink1").onclick = function(){
	...
	document.querySelector('.starbucks').src ="/images/tea-coffee-drink-starbucks-latte.png";
...
document.getElementById("changePink2").onclick = function(){
	...
	document.querySelector('.starbucks').src ="/images/frappuccino-drink-latte-starbucks-unicorn.png";
